                        ...
                        <ul className={styles.WriterInfo}>
                            ...
                            <li>
                                <div className={styles.profile_area}>
                                    <button className={styles.profile_Info}>{data[0]['user']}</button>
                                    <div className={styles.article_Info}>
                                        <span className={styles.date}>{data[0]['create_dt']}</span>
                                        <span className={styles.count}>조회 {data[0]['view_count']}</span>
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div className={styles.article_container}>
                            ...
                            <a className={styles.like_btn_container}>
                                <span
                                    ...
                                    {likeState ? (
                                        ...
                                        <img src='https://cdn4.iconfinder.com/data/icons/48-bubbles/48/39.Heart-512.png' width={17} />
                                    )}
                                </span>
                                    ...
                                    return (
                                        <div className={styles.comment_area}>
                                            ...
                                            <div class={styles.comment_box}>
                                                <div class={styles.comment_nick_box}>{data_com['user']}</div>
                                                <div class={styles.comment_text_box}>{data_com['comment']}</div>
                                                <div class={styles.comment_info_box}>{data_com['create_dt']}</div>
                                            </div>
                                        </div>
                                    );
                                })}
                        ...
                        <div className={styles.CommentWritter}>
                            <div className={styles.comment_inbox}>
                                ...
                                <textarea placeholder='댓글을 남겨보세요' row='1' class={styles.comment_inbox_text}></textarea>
                            </div>
