...
from users.views import RegisterView, LoginView, UserView, UpdatePartialUserView, LogoutView, ChangePasswordView, CheckPasswordToken, ResetPasswordView, SetPasswordView
# from . import views
app_name = 'users'
urlpatterns = [
